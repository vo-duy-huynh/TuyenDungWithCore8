...
namespace TuyenDungWeb.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        {
            var message = await _context.MessageChats.FindAsync(id);
            if (message == null)
                return NotFound();
        ...
        public IActionResult GetMessages(string roomName)
        {
            ...
            var messages = _context.MessageChats.Where(m => m.ToRoomId == room.Id)
            ...
            var messagesViewModel = _mapper.Map<IEnumerable<MessageChat>, IEnumerable<MessageViewModel>>(messages);
        ...
        public async Task<ActionResult<Message>> Create(MessageViewModel viewModel)
        {
            ...
            _context.MessageChats.Add(msg);
            await _context.SaveChangesAsync();

            // Broadcast the message
            var createdMessage = _mapper.Map<MessageChat, MessageViewModel>(msg);
        ...
        {
            var message = await _context.MessageChats
